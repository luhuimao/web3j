...
RpcSerializer._CIPHER_PAD = CIPHER_PAD;
RpcSerializer._strPack = strPack;
RpcSerializer._prependCount = prependCount;
RpcSerializer._adjustForSearch = adjustForSearch;
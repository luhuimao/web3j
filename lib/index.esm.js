...
import { parse, format as format$1 } from 'url';
...
function () {
  ...
  _createClass(Transaction, [{
    ...
    key: "signTx",
    value: function signTx() {
      this.signTxInPartial.apply(this, arguments);
    }
    /**
    ...
    key: "signTxInPartial",
    value: function signTxInPartial() {
    ...
    key: "addSignerINtoSignature",
    value: function addSignerINtoSignature(signer) {
...
var GetClusterNodes = jsonRpcResult(struct$1.list([struct$1({
  bvmaddr: 'string',
  kingnodeip: 'string',
  txProcessIp: struct$1.union(['null', 'string']),
...
var GetClusterNodes_tmp = jsonRpcResult(struct$1.list([struct$1({
  id: 'string',
  kingnodeip: 'string',
  txProcessIp: struct$1.union(['null', 'string']),
  rpc: struct$1.union(['null', 'string'])
...
function () {
  ...
  function Connection(endpoint) {
    ...
    this._rpcWebSock = new Client(format$1(url), {
      autoconnect: false,
  ...
  _createClass(Connection, [{
          ...
          while (1) {
            switch (_context7.prev = _context7.next) {
              ...
              case 2:
                ...
                _context7.prev = 3;
                res_tmp = GetClusterNodes_tmp(unsafeRes);
              ...
              case 8:
                return _context7.abrupt("return", res_tmp.result.map(function (node) {
    ...
    value: function () {
      ...
      _regeneratorRuntime.mark(function _callee13() {
        var unsafeRes, res_tmp, _res_tmp$result, blockhash, gasCounter, res;
          ...
          while (1) {
            switch (_context13.prev = _context13.next) {
              ...
              case 2:
                ...
                _context13.prev = 3;
                res_tmp = GetRecentBlockhash_015(unsafeRes);
              ...
              case 7:
                _res_tmp$result = _slicedToArray(res_tmp.result, 2), blockhash = _res_tmp$result[0], gasCounter = _res_tmp$result[1];
                gasCounter.targetSignaturesPerSlot = 42;
                gasCounter.targetDifsPerSignature = gasCounter.difsPerSignature;
                return _context13.abrupt("return", [blockhash, gasCounter]);
          ...
          while (1) {
            switch (_context16.prev = _context16.next) {
              ...
              case 1:
                ...
                transaction.signTx.apply(transaction, signers);
...
function () {
  ...
  _createClass(SystemController, null, [{
    ...
    key: "transferDifs",
    value: function transferDifs(from, to, amount) {
    ...
    key: "assignToController",
    value: function assignToController(from, controllerId) {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 8:
                ...
                _transaction = new Transaction().addOperations({
                  keys: [{
              ...
              case 26:
                ...
                _transaction2 = new Transaction().addOperations({
                  keys: [{
                    pubkey: controller.pubKey,
                    isSigner: true,
                    isDebitable: true
        ...
        case 1:
          {
            ...
            return _transaction.addOperations({
              keys: [{
                pubkey: controller,
                isSigner: false,
                isDebitable: true
        ...
        case 2:
          {
            ...
            return _transaction2.addOperations({
              keys: [{
                pubkey: controller,
                isSigner: false,
                isDebitable: true
 ...
 * @private
 */
var AssetDetailLayout = struct([uint64('totalSupply'), u8('decimalsPosition'), rustString('name'), rustString('symbol')]); /////////////////////////////////////////////////////////////////////////////////////////////

/**
 * @private
 */
var TokenAccountDetailLayout = struct([pubKey('publickeyOfAsset'), pubKey('publickeyOfOwner'), uint64('amountOfAsset'), u8('sourceOption'), pubKey('publickeyOfSourceAccount'), uint64('originalAmountOfAsset')]);
// This type exists to workaround an esdoc parse error
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 5:
                ...
                _context4.t4 = _context4.t2.addOperations.call(_context4.t2, _context4.t3);
                _context4.t5 = owner;
                _context4.next = 10;
        ...
        return _regeneratorRuntime.wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                _context5.next = 2;
                return launchThenAcknowledgeTx(this.connection, new Transaction().addOperations(this.approveOperation(ownerAccount.pubKey, publickeyOfAssetAccount, publickeyOfDelegateAccount, amountAsset)), ownerAccount);
        ...
        return _regeneratorRuntime.wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                _context6.next = 2;
                return launchThenAcknowledgeTx(this.connection, new Transaction().addOperations(this.setOwnerOperation(ownerAccount.pubKey, publickeyOfAssetAccount, publickeyOfNewOwner)), ownerAccount);
        ...
        return _regeneratorRuntime.wrap(function _callee7$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
              ...
              case 5:
                dataLayout = struct([u32('instruction'), uint64('amountAsset')]);
                data = Buffer.alloc(dataLayout.span);
                dataLayout.encode({
                  instruction: 2,
          ...
          while (1) {
            switch (_context8.prev = _context8.next) {
              ...
              case 5:
                ...
                dataLayout = struct([u32('instruction'), uint64('totalSupply'), u8('assetDecimals'), rustString('assetName'), rustString('assetSymbol')]);
...
export { Asset, AssetCount, BpfControllerLoader, BudgetController, BvmAcct, BvmAddr, Connection, ControllerLoader, NativeControllerLoader, PreCondition, RpcCall_1 as RpcCall, RpcParameter_1 as RpcParameter, SystemController, Transaction, TxOperation, launchThenAcknowledgeNativeTxn, launchThenAcknowledgeTx };

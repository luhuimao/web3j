...
function () {
  ...
  _createClass(PubKey, [{
    ...
    value: function toString() {
      return reverse(this.toBase58()); // return this.toBase58();
    }
  }], [{
    key: "isPubKey",
...
function () {
  ...
  _createClass(Asset, [{
    ...
    value: function () {
        ...
        return _regeneratorRuntime.wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                _context5.next = 2;
                return launchThenAcknowledgeTx(this.connection, new Transaction().add(this.approveOperation(owner.pubKey, account, delegate, amount)), owner);
      ...
      function approve(_x19, _x20, _x21, _x22) {
    ...
    value: function () {
        ...
        return _regeneratorRuntime.wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                _context6.next = 2;
                return launchThenAcknowledgeTx(this.connection, new Transaction().add(this.setOwnerOperation(owner.pubKey, account, newOwner)), owner);
      ...
      function setOwner(_x23, _x24, _x25) {
...
export { Asset, AssetCount, BpfControllerLoader, BudgetController, BusAccount, Connection, ControllerLoader, NativeControllerLoader, PreCondition, PubKey, RpcCall_1 as RpcCall, RpcParameter_1 as RpcParameter, SystemController, Transaction, TxOperation, launchThenAcknowledgeNativeTxn, launchThenAcknowledgeTx, testnetChannelEndpoint };
